-- country,state,city tables inert queries : 21-Mar-2021 : Start

insert into spring_db.tbl_country(country_id,country_code,country_name,phone_code) values
...
(4120, 'Midlands', 246);
-- country,state,city tables inert queries : 21-Mar-2021 : End